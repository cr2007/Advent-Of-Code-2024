...
There's just one problem: by holding the two lists up **side by side** ([your puzzle input](./input.txt)), it quickly becomes clear that the lists aren't very similar.
